		...
		var e, f, g, h, i, j = {},
			...
			A = function () {
				...
				return [a("<div>").addClass("datepicker-days").append(a("<table>").addClass("table-condensed").append(bRTL).append(a("<tbody>"))), a("<div>").addClass("datepicker-months").append(a("<table>").addClass("table-condensed").append(bRTL.clone()).append(c.clone())),
						...
						a("<div>").addClass("datepicker-years").append(a("<table>").addClass("table-condensed forceLTR").append(b.clone()).append(c.clone()))
			...
			B = function () {
				...
				return x("h") && (b.append(a("<td>").append(a("<a>").attr({
					...
					a("<div>").addClass("timepicker-picker").append(a("<table>").addClass("table-condensed forceLTR").append([b, c, e]))
			},
			/********<myedit**********/
			C = function () {
				/********myedit>**********/
					/*force make table LTR in RTL for example rtl for time is not good as in persian we write 23:59 so in select we follow how we write*/
					/*note: forceLTR style has been added in rtl-edit to make direction to ltr*/
				var b = a("<div>").addClass("timepicker-hours").append(a("<table>").addClass("table-condensed forceLTR")),
					c = a("<div>").addClass("timepicker-minutes").append(a("<table>").addClass("table-condensed forceLTR")),
					d = a("<div>").addClass("timepicker-seconds").append(a("<table>").addClass("table-condensed forceLTR")),
					/********<myedit**********/
					e = [B()];
