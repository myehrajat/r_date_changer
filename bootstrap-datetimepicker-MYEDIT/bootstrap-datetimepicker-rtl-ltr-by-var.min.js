...
! function (a) {
	...
	var c = function (c, d) {
		var e, f, g, h, i, j = {},
			...
			A = function () {
				/********myedit>**********/
				/*make icons.previous to icons.next and icons.next to icons.previous
				we create bRTL*/
				
				var bRTL = a("<thead>").append(a("<tr>").append(a("<th>").addClass("prev").attr("data-action", "previous").append(a("<span>").addClass(d.icons.next))).append(a("<th>").addClass("picker-switch").attr("data-action", "pickerSwitch").attr("colspan", d.calendarWeeks ? "6" : "5")).append(a("<th>").addClass("next").attr("data-action", "next").append(a("<span>").addClass(d.icons.previous)))),
				cRTL = a("<tbody>").append(a("<tr>").append(a("<td>").attr("colspan", d.calendarWeeks ? "8" : "7")));
				...
				/********myedit>**********/
				/*alert(momentVars.cal_direction);*/
				/*know how arrow should be for rtl and ltr use bRTL which we create before in this part */
				if(momentVars.cal_direction == 'ltr'){
					/*make days and month selection RTL better for persian note that year selection is like ltr so no need*/
					/* append(b) replaced with append(bRTL)*/
				return [a("<div>").addClass("datepicker-days").append(a("<table>").addClass("table-condensed").append(bRTL).append(a("<tbody>"))), a("<div>").addClass("datepicker-months").append(a("<table>").addClass("table-condensed").append(bRTL.clone()).append(c.clone())),
						
						a("<div>").addClass("datepicker-years").append(a("<table>").addClass("table-condensed").css("direction","ltr").append(b.clone()).append(c.clone()))
						

					   ]
				}else{
					/********<myedit**********/
				return [a("<div>").addClass("datepicker-days").append(a("<table>").addClass("table-condensed").append(b).append(a("<tbody>"))), a("<div>").addClass("datepicker-months").append(a("<table>").addClass("table-condensed").append(b.clone()).append(c.clone())),
			...
			B = function () {
				...
				return x("h") && (b.append(a("<td>").append(a("<a>").attr({
					...
					href: "#",
					tabindex: "-1"
				}).addClass("btn").attr("data-action", "decrementSeconds").append(a("<span>").addClass(d.icons.down))))), f || (b.append(a("<td>").addClass("separator")), c.append(a("<td>").append(a("<button>").addClass("btn btn-primary").attr("data-action", "togglePeriod"))), e.append(a("<td>").addClass("separator"))),
					/********myedit>**********/
					/*force make table LTR in RTL for example rtl for time is not good as in persian we write 23:59 so in select we follow how we write*/
					/*note: forceLTR style has been added in rtl-edit to make direction to ltr*/
					a("<div>").addClass("timepicker-picker").append(a("<table>").addClass("table-condensed").css("direction","ltr").append([b, c, e]))
			},
			/********<myedit**********/
			C = function () {
				/********myedit>**********/
					/*force make table LTR in RTL for example rtl for time is not good as in persian we write 23:59 so in select we follow how we write*/
					/*note: forceLTR style has been added in rtl-edit to make direction to ltr*/
				var b = a("<div>").addClass("timepicker-hours").append(a("<table>").addClass("table-condensed").css("direction","ltr")),
					c = a("<div>").addClass("timepicker-minutes").append(a("<table>").addClass("table-condensed").css("direction","ltr")),
					d = a("<div>").addClass("timepicker-seconds").append(a("<table>").addClass("table-condensed").css("direction","ltr")),
					/********<myedit**********/
					e = [B()];
