<?php 
 ...
 /*
 ************************************WE ADD 2 at the end of all function to prevent jalali conflict**************************
 * @method gregorian_to_jalali2 ($g_y, $g_m, $g_d,$str)       return gregorian to jalali converted date 
 * @method jalali_to_gregorian2($j_y, $j_m, $j_d,$str)        return jalali to gregorian converted date 
 * 
...
function gregorian_to_jalali2 ($g_y, $g_m, $g_d,$str) 
{ 
...
function jalali_to_gregorian2($j_y, $j_m, $j_d,$str) 
{ 
    $g_days_in_month = array(31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31); 
    $j_days_in_month = array(31, 31, 31, 31, 31, 31, 30, 30, 30, 30, 30, 29); 
...
function comparedate2($_date_mix_jalaly,$_date_mix_gregorian)
{
  $_date_arr_jalaly = explode('/', $_date_mix_jalaly);
  $_date_arr_gregorian = explode('/', $_date_mix_gregorian);		
  
  $arr_jtg = jalali_to_gregorian2($_date_arr_jalaly[0],$_date_arr_jalaly[1],$_date_arr_jalaly[2]);
